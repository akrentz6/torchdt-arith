...
log_filename = f"shufflenetv2_fp_train_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
history_filename = f"shufflenetv2_fp_history_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"

save_dir = "./checkpoints"
os.makedirs(save_dir, exist_ok=True)

best_model_filename = os.path.join(save_dir, f"shufflenetv2_fp_best_{datetime.now().strftime('%Y%m%d_%H%M%S')}.pt")
final_model_filename = os.path.join(save_dir, f"shufflenetv2_fp_final_{datetime.now().strftime('%Y%m%d_%H%M%S')}.pt")
